...
// set up variables to store the ID's of selected components to ensure only that selected component gets addressed
...
inquirer.prompt(emplQuestions).then(responses => {
